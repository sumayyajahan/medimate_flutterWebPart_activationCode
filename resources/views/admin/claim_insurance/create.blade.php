...
<div class="container">
    ...
    <form id="inputform"  class="form-group" action="{{route('claim-insurance.submit')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <table class="table table-bordered">
            ...
            <div class="row" id="individual1">
                ...
                <div class="col-md-6">
                    <input  data-index="1" type="text" name="member_id" class="form-control" value="{{ $enroll->user_id }}">
                </div>
            </div>
            <div class="row" id="individual2">
                ...
                <div class="col-md-6">
                    <input  data-index="2" type="text" name="insured_name" class="form-control">
                </div>
            </div>
            <div class="row" id="individual3">
                ...
                <div class="col-md-6">
                    <input  data-index="3" type="text" name="patient_name" class="form-control">
                </div>
            </div>
            <!-- </div> -->
            <!-- <div id="organization"> -->
            <div class="row" id="organization1">
                ...
                <div class="col-md-6">
                    <input  data-index="4" type="text" name="org_name" class="form-control">
                </div>
            </div>
            ...
            <div class="row" id="organization2">
                ...
                <div class="col-md-6">
                    <input  data-index="5" type="text" name="org_mobile" class="form-control">
                </div>
            </div>
            <div class="row" id="organization3">
                ...
                <div class="col-md-6">
                    <input  data-index="6" type="text" name="org_mobile_alt" class="form-control">
                </div>
            </div>
            <!-- </div> -->
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <input  data-index="7" type="text" name="hospital_name" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="8" type="text" name="hospital_area" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="9" type="text" name="admission_date" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="10" type="text" name="discharge_date" class="form-control">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <input  data-index="11" type="text" name="accommodation_charge" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="12" type="text" name="doctor_fee" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="13" type="text" name="test_fee" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="14" type="text" name="medicine_cost" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="15" type="text" name="surgical_cost" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="16" type="text" name="ancillary_fee" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="17" type="text" name="other_expenses" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="18" type="text" name="discount" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="19" type="text" name="claim_amount" class="form-control">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <input  data-index="20" type="text" name="ac_name" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="21" type="text" name="ac_no" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="22" type="text" name="bank_name" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="23" type="text" name="routing_number" class="form-control">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  <input  data-index="24" type="file" name="signature_employee" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <input  data-index="25" type="file" name="signature_coordinator" class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <input  data-index="26" type="file" name="signature_officer" class="form-control">
                </div>
            </div>
            <div class="row">
