...
class InsuranceEnrollController extends Controller
{
    ...
    {
        $insurance_enrolls = InsuranceEnroll::where('user_id', Auth::id())
            ->whereNotIn('status', [2,9])
            ->whereNotIn('is_approved', [2,9])
            ->orderBy('id', 'DESC')->get();
        $enrolls = array();
...
//        return response()->json($input);
        ...
        $cuttly_api = 'c48bb2f83ecd9cb9dc7848498d2719cac8fa1'; //config('app.cuttly_api');
